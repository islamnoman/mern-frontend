        ...
        <React.Fragment>
            ...
            <div className="container">
                ...
                <div className="col-md-3">
                    ...
                    <a href="#" className={`text-white ${rtl}`}>{t('footer.upper.col2.instragram')}</a> <br />
                </div>
            ...
            <div className="row mt-3 mx-0 px-0">
                ...
                <img src="assets/img/mojo.png" height="30" width="100" alt="amazon logo white footer"/>
                </div>
            </div>
            ...
            <div className="py-3 mt-3 shadow-lg" style={{ backgroundColor: "#131a22", fontSize: "12px" }}> 
                ...
                <div className="row my-5">
                    ...
                    <p>
                        <i className="far fa-copyright"></i> { "2018-" + (new Date().getFullYear()) + ", " + t('footer.ending_title')}
                    </p>
                    </div>
                </div>
