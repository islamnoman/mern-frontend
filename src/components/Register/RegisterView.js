            ...
            <div className="card mx-auto mt-5 pb-3 shadow rounded" style={{width: "25rem"}}>
                <div className="card-body">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" name="name" className="form-control" placeholder="NoMan islam" id="userName" value={props.name} onChange={props.handleChange} required minLength="3" />
