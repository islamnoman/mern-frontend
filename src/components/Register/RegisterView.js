            ...
            <div className="card mx-auto mt-5 pb-3 shadow rounded" style={{width: "25rem"}}>
                <div className="card-body">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" name="name" className={`form-control ${rtl}`} placeholder="NoMan islam" id="userName" value={props.name} onChange={props.handleChange} required minLength="3" />
                    ...
                    <div className="form-group">
                        ...
                        <small id="passwordHelp2" className={`form-text text-muted ${rtl}`}><i className="fas text-primary fa-info"></i>{t('register.password2_info')} </small>
                        <div className={`valid-feedback ${rtl}`}>
                        <i className="far text-success fa-thumbs-up"></i> {t('validation.ok')}
                        </div>
                        <div className={`invalid-feedback ${rtl}`}>
